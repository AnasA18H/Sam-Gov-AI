  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-gray-50 dark:bg-matte">
        {/* Navigation */}
        <nav className="bg-white dark:bg-dark-elevated border-b border-gray-200 dark:border-gray-700 shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-14">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  onClick={() => navigate('/dashboard')}
                  className="inline-flex items-center justify-center px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-dark-hover border border-gray-300 dark:border-dark-border rounded-lg hover:bg-gray-50 dark:hover:bg-dark-border focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-black focus:ring-gray-400 dark:focus:ring-gray-500 transition-colors"
        ...
        <main className="max-w-3xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-dark-elevated rounded-lg border border-gray-200 dark:border-dark-border shadow-lg overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-dark-border bg-[#14B8A6] dark:bg-teal-600 rounded-t-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-medium text-white/80 mt-1">
                    Paste the full URL from your browser when viewing a solicitation on SAM.gov.
                  </p>
                </div>
              </div>
            </div>
            <div className="px-6 py-4 rounded-b-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {error && (
                  <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 px-4 py-3 rounded-lg text-sm flex items-center space-x-2">
                ...
                <div>
                  <label htmlFor="samGovUrl" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    SAM.gov Opportunity URL <span className="text-red-500">*</span>
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <HiOutlineGlobe className="h-5 w-5 text-gray-400 dark:text-gray-500" />
                    </div>
                    <input
                      id="samGovUrl"
                      name="samGovUrl"
                      type="url"
                      required
                      className="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-dark-border rounded-lg text-sm placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#14B8A6] dark:focus:ring-teal-500 focus:border-[#14B8A6] dark:focus:border-teal-500 transition-all bg-white dark:bg-dark-hover text-gray-900 dark:text-white hover:border-gray-400 dark:hover:border-gray-500"
                ...
                <div>
                  <label htmlFor="files" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Additional Documents <span className="text-gray-400 dark:text-gray-500 font-normal">(Optional)</span>
                  </label>
                  <div className="relative">
                    <label
                      htmlFor="files"
                      className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 dark:border-dark-border border-dashed rounded-lg cursor-pointer bg-gray-50 dark:bg-dark-hover/50 hover:bg-gray-100 dark:hover:bg-gray-700 hover:border-gray-400 dark:hover:border-gray-500 transition-colors group"
                    >
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        <HiOutlineUpload className="w-8 h-8 mb-2 text-gray-400 dark:text-gray-500 group-hover:text-gray-500 dark:group-hover:text-gray-400" />
                        <p className="mb-2 text-sm text-gray-500 dark:text-gray-300">
                          <span className="font-semibold">Click to upload</span> or drag and drop
                        </p>
                        <p className="text-xs text-gray-400 dark:text-gray-500">PDF, DOC, DOCX, XLS, XLSX (MAX. 10MB per file)</p>
                      </div>
                      <input
                        id="files"
                        name="files"
                  ...
                  {files.length > 0 && (
                    <div className="mt-4 space-y-2">
                      <p className="text-xs font-medium text-gray-700 dark:text-gray-300">Selected files ({files.length}):</p>
                      <div className="space-y-2">
                        {files.map((file, index) => (
                          <div key={index} className="flex items-center justify-between p-2 bg-gray-50 dark:bg-dark-hover border border-gray-200 dark:border-dark-border rounded-lg">
                            <div className="flex items-center space-x-2 flex-1 min-w-0">
                              <HiOutlineDocumentText className="w-4 h-4 text-gray-400 dark:text-gray-500 flex-shrink-0" />
                              <span className="text-sm text-gray-700 dark:text-gray-300 truncate">{file.name}</span>
                            </div>
                            <button
                              type="button"
                              onClick={() => setFiles(files.filter((_, i) => i !== index))}
                              className="ml-2 p-1 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 rounded transition-colors"
                            >
                ...
                <div className="space-y-3 pt-3 border-t border-gray-200 dark:border-dark-border">
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-dark-hover/50 rounded-lg border border-gray-200 dark:border-dark-border">
                        ...
                        <button
                          ...
                          className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#14B8A6] dark:focus:ring-teal-500 focus:ring-offset-2 dark:focus:ring-offset-black ${
                            enableDocumentAnalysis ? 'bg-[#14B8A6] dark:bg-teal-500' : 'bg-gray-300 dark:bg-gray-600'
                          }`}
                          role="switch"
                      ...
                      <div className="flex items-center justify-between p-2.5 bg-gray-50 dark:bg-dark-hover/50 rounded-lg border border-gray-200 dark:border-dark-border">
                        ...
                        <button
                          ...
                          className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#14B8A6] dark:focus:ring-teal-500 focus:ring-offset-2 dark:focus:ring-offset-black ${
                            enableClinExtraction && enableDocumentAnalysis ? 'bg-[#14B8A6] dark:bg-teal-500' : 'bg-gray-300 dark:bg-gray-600'
                    ...
                    <p className="mt-3 text-[11px] font-medium app-note">
                      Note: Document Analysis must be enabled for CLIN Extraction to work. 
                ...
                <p className="pt-2 text-[11px] text-gray-500 dark:text-gray-400">
                  Analysis may take a few minutes. You&apos;ll be taken to the opportunity page when ready.
                </p>
                <div className="pt-3 flex items-center justify-end space-x-3 border-t border-gray-200 dark:border-dark-border">
                  <button
                    type="button"
                    onClick={() => navigate('/dashboard')}
                    className="inline-flex items-center justify-center px-4 py-2.5 border border-gray-300 dark:border-dark-border rounded-lg shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-dark-hover hover:bg-gray-50 dark:hover:bg-dark-border focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-black focus:ring-gray-400 dark:focus:ring-gray-500 transition-colors"
                    title="Cancel"
                  ...
                  <button
                    ...
                    aria-label={loading ? 'Processing...' : 'Begin analysis'}
                  >
                    {loading ? (
                      <>
